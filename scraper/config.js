...
export const config = {
  ...
  junehomes: { maxPages: num(process.env.JUNEHOMES_PAGES, 4), maxDetails: num(process.env.JUNEHOMES_DETAILS, 40) },
  roomster: { maxPages: num(process.env.ROOMSTER_PAGES, 3), maxDetails: num(process.env.ROOMSTER_DETAILS, 45) },
  reddit: {
